...
class TestHBNBCommand_prompting(unittest.TestCase):
    """Unittests for evaluating prompting of the HBNB command interpreter."""
...
class TestHBNBCommand_help(unittest.TestCase):
    ...
    def test_help_update(self):
        h = ("Usage: update <class> <id> <attribute_name> <attribute_value> or"
             ...
             "     a given attribute key or value pair, or dictionary.")
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_exit(unittest.TestCase):
    """Unittests for evaluating exiting from the HBNB command interpreter."""
...
class TestHBNBCommand_create(unittest.TestCase):
    """Unittests for evaluating create command from the HBNB command interpreter."""
...
class TestHBNBCommand_show(unittest.TestCase):
    """Unittests for evaluating show from the HBNB command interpreter"""
...
class TestHBNBCommand_destroy(unittest.TestCase):
    """Unittests for evaluating destroy from the HBNB command interpreter."""
...
class TestHBNBCommand_all(unittest.TestCase):
    """Unittests for evaluating all of the HBNB command interpreter."""
...
class TestHBNBCommand_update(unittest.TestCase):
    """Unittests for evaluating update from the HBNB command interpreter."""
...
class TestHBNBCommand_count(unittest.TestCase):
    """Unittests for evaluating count method of HBNB comand interpreter."""
